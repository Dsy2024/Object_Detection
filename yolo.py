...
model = YOLO("outputs/yolo11n_detect_OX/weights/best.pt")
...
def yolo_train():
    ...
    model.train(data="config.yaml", epochs=100, imgsz=640, project="outputs/", name="yolo11n_detect") # The model output path will be outputs/yolo11n_detect/weights/best.pt
